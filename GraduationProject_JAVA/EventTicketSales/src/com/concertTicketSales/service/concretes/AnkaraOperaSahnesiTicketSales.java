...
public class AnkaraOperaSahnesiTicketSales implements BaseTicketSalesSystem {
    ...
    public void getTicketSales(Event event) {
        ...
        System.out.println("*********************************\n" +
                "Ankara Opera Sahnesi Bilet Satış Noktamıza Hoş Geldiniz\n" +
                "Bale / P.İ. ÇAYKOVSKİ Kuğu Gölü ( 25 Ağustos 2021 / 21:30 )\n"+"etkinliği bilet satış sayfası\n"+
                "*********************************\n");
        ...
        System.out.print("Bale / P.İ. ÇAYKOVSKİ Kuğu Gölü ( 25 Ağustos 2021 / 21:30 ) etkinliği için: \n"+
